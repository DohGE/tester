                    ...
                    .pipe(
                        ...
                        catchError((error) => {
                            if (
                                ...
                                error.error.error.message == EmailEnum.fail
                            ) {
                                this.notificationService.showError(
                ...
                this.authService
                    ...
                    .pipe(
                        ...
                        catchError((error) => {
                            ...
                            if (
                                error.error.error?.message ==
                                    EmailEnum.emailNotFound ||
                                error.error.error?.message ==
                                    EmailEnum.invalidPassword
                            ) {
                                errorMessage =
                                    "Podany e-mail lub hasło jest nieprawidłowy!";
                            } else if (
                                error.error.error?.message ==
                                EmailEnum.tooManyAttemptsTryLater
                            ) {
                                errorMessage =
                            ...
                            return of(
                                authActions.logInFail({ error: errorMessage })
                            );
                        })
                    )
            )
